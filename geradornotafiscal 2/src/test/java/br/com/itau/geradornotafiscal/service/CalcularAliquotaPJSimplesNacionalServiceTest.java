...
public class CalcularAliquotaPJSimplesNacionalServiceTest {
	
	@InjectMocks
	private CalcularAliquotaPJSimplesNacionalService calcularAliquotaPJSimplesNacionalService;
	...
	public void shouldCalcularAliquotaBasePessoaJuridicaLucroPresumido() throws Exception {
		...
		List<ItemNotaFiscal> itemNotaFiscalList = calcularAliquotaPJSimplesNacionalService
